...
class TextFieldForm extends StatelessWidget {
  ...
  const TextFieldForm({super.key, this.hintText, this.labelText,this.controller,this.isPasswordField,this.color,this.validator,this.inputType, required this.icon, this.icons});
